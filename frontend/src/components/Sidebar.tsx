          ...
          return (
            ...
            >
              <div className="relative mx-auto lg:mx-0">
                ...
                {unreadCount > 0 && (
                  <span className="absolute -top-1 -right-1 min-w-5 h-5 px-1 rounded-full bg-primary text-primary-content text-[10px] font-semibold flex items-center justify-center">
              ...
              <div className="hidden lg:block text-left min-w-0">
                <div className="font-medium truncate flex items-center gap-2">
                  ...
                  {unreadCount > 0 && <span className="badge badge-primary badge-sm">{unreadCount > 99 ? "99+" : unreadCount}</span>}
                </div>
